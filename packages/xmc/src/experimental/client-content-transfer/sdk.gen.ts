...
import type { EXPERIMENTAL_ContentTransfer } from './types.gen';
import { client as _heyApiClient } from './client.gen';

type GetBlobStateResponse = EXPERIMENTAL_ContentTransfer.GetBlobStateResponse;

type GetBlobStateData = EXPERIMENTAL_ContentTransfer.GetBlobStateData;

type ConsumeFileData = EXPERIMENTAL_ContentTransfer.ConsumeFileData;

type DeleteContentTransferData = EXPERIMENTAL_ContentTransfer.DeleteContentTransferData;

type CompleteChunkSetTransferResponse =
  EXPERIMENTAL_ContentTransfer.CompleteChunkSetTransferResponse;

type CompleteChunkSetTransferData = EXPERIMENTAL_ContentTransfer.CompleteChunkSetTransferData;

type SaveChunkData = EXPERIMENTAL_ContentTransfer.SaveChunkData;

type GetChunkResponse = EXPERIMENTAL_ContentTransfer.GetChunkResponse;

type GetChunkData = EXPERIMENTAL_ContentTransfer.GetChunkData;

type GetContentTransferStatusResponse =
  EXPERIMENTAL_ContentTransfer.GetContentTransferStatusResponse;

type GetContentTransferStatusData = EXPERIMENTAL_ContentTransfer.GetContentTransferStatusData;

type CreateContentTransferData = EXPERIMENTAL_ContentTransfer.CreateContentTransferData;
