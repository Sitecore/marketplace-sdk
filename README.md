...
- `ai` – extends the Client SDK and provides type-safe interfaces for interacting with AI APIs. For more information, refer to the package [README](packages/ai/README.md).
...
If your app needs to interact with AI APIs, install the `ai` package:
...
│     ├── ai      // AI module (integration with Sitecore AI APIs)
