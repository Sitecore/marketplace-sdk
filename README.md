...
- `ai` – extends the Client SDK and provides type-safe interfaces for interacting with AI skills and documents APIs. For more information, refer to the package [README](packages/ai/README.md).
...
If your app needs to interact with AI skills or documents APIs, install the `ai` package:
