...
- The `xmc` package also provides the Feature Flags API namespace.
...
The `xmc` package includes the Feature Flags API namespace.
...
│     └── xmc     // XMC module (integration with Sitecore XM Cloud and Feature Flags APIs)
